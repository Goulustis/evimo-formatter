...
# NOTE: TAKEN DIRECTLY FROM EVIMO_FLOW.PY
...
def viz_points(pos, pos2=None):
    ...
    if pos2 is not None:
        ax.scatter(pos2[:, 0], pos2[:, 1], pos2[:, 2], c='b', marker='^')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--overwrite', dest='overwrite', action='store_true', help='Overwrite existing output files', default=True)
    ...
    parser.add_argument('--format', dest='format', type=str, help='"evimo2v1" or "evimo2v2" input data format', default="evimo2v2")
    parser.add_argument('--reprojectbgr', dest='reproject_bgr', action='store_true', help='Reproject a classical camera measurement into the flow frame', default=True)
    ...
    parser.add_argument('files', nargs='*',help='NPZ files to convert', default=["/ubc/cs/research/kmyi/matthew/backup_copy/raw_real_ednerf_data/evimo2_v2_data/npz/samsung_mono/sfm/eval/scene_03_03_000002"])
    # parser.add_argument('files', nargs='*',help='NPZ files to convert', default=["/ubc/cs/research/kmyi/matthew/backup_copy/raw_real_ednerf_data/evimo2_v2_data/npz/samsung_mono/sanity/checkerboard/checkerboard_2_tilt_fb_000000"])
